...
//                    else if(ss[0].equals("position")){
                    ...
                    else if(ss[0].equals("_readhtt")){
                        listAction.add(new _ReadHTTAction(name, stepid, actionMemo,this, ss));
                        stepid++;
                        actionMemo = "";
                    }
                    ...
                    else if(ss[0].equals("_readqktx")){
                        listAction.add(new _ReadQKTXAction(name, stepid, actionMemo,this, ss));
                        stepid++;
                        actionMemo = "";
                    }
                    else if(ss[0].equals("_readhstt")){
                        listAction.add(new _ReadHSTTAction(name, stepid, actionMemo,this, ss));
                        stepid++;
                        actionMemo = "";
                    }
