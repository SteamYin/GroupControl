...
public class ImageUtils {
    ...
    public static void cutImage(String srcpath, String subpath, int x, int y, int w, int h)
            throws Exception {
        // 首先通过ImageIo中的方法，创建一个Image + InputStream到内存
        ImageInputStream iis = ImageIO
                .createImageInputStream(new FileInputStream(srcpath));
    ...
    public final static void gray(String srcImageFile, String destImageFile) {
        try {
            ...
            ImageIO.write(src, "png", new File(destImageFile));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
     ...
     * @return
     */
    public static int getPixel(String img, int x, int y){
